...
namespace Raytracer
{
    class Program
    {
        ...
        static void ChangeSettings()
        {
            ...
            Console.WriteLine("9: Max Degree Of Parallelism");
            Console.WriteLine("10: Show PPM File");
            ...
            try
            {
                switch (choice)
                {
                    ...
                    case "8":
                        ...
                        break;
                    case "9":
                        Console.Write("Enter Max Degree Of Parallelism: ");
        ...
        static void RunTests()
        {
            ...
            for (int testNum = 1; testNum <= numberOfTests; testNum++)
            {
                ...
                {
                    actualSeed = (int)DateTime.Now.Ticks + testNum;
                }
                ...
                // Render with MaxDegreeOfParallelism
                cam.Render(world, outputFile, new ParallelOptions { MaxDegreeOfParallelism = maxDegreeOfParallelism });
            ...
            for (int a = -8; a < 8; a++)
            {
                for (int b = -8; b < 8; b++)
                {
                    ...
                    if (matType == 0)
                    {
                        ...
                        double bl = random.NextDouble();
                        Vec3 albedoVec = new Vec3(r * r, g * g, bl * bl);
                    ...
                    else if (matType == 1)
                    {
                        ...
                        double bl = random.NextDouble() * 0.5 + 0.5;
                        Vec3 albedoVec = new Vec3(r, g, bl);
                        Color albedo = new Color(albedoVec.X(), albedoVec.Y(), albedoVec.Z());
